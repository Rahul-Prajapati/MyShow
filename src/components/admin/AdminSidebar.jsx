...
const AdminSidebar = () => {
  ...
  return (
    <div className='h-[calc(100vh-64px)] md:flex flex-col item-center pt-8 max-w-13 md:max-w-60 w-full border-gray-300/20 text-sm'>
      ...
      <p className='mt-2 text-center text-base max-md:hidden'>
      ...
      <div className='w-full'>
        ...
        {adminNavlinks.map((link, index) => (
          <NavLink 
            ...
            className={({ isActive}) => 
                `relative flex items-center max-md:justify-center gap-2 w-full py-2.5 md:pl-10 first:mt-6 text-gray-400 ${isActive && 'bh-primary/15 text-primary group'} `} >
            {({isActive}) =>(
              <>
